...
CREATE TABLE Tyre (id BIGINT NOT NULL, prodMonth INTEGER, prodYear INTEGER, profileHeigth INTEGER, speedRating VARCHAR(20), treadWidth INTEGER, USAGE0 VARCHAR(20), vendor VARCHAR(20), wheelDiameter INTEGER, optlock INTEGER, CUSTOMER_ID BIGINT, PRIMARY KEY (id)) ENGINE = innodb;
...
ALTER TABLE Tyre ADD FOREIGN KEY (CUSTOMER_ID) REFERENCES Customer (id);
