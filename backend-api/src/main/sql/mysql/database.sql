CREATE TABLE CaroLineUser (id BIGINT NOT NULL, active BIT, firstName VARCHAR(50), lastName VARCHAR(50), loginHash VARCHAR(255), loginId VARCHAR(255), DTYPE INTEGER, optlock INTEGER, PRIMARY KEY (id), UNIQUE U_CRLNUSR_LOGINID (loginId)) ENGINE = innodb;
...
CREATE TABLE StorageSlot (id BIGINT NOT NULL, optlock INTEGER, CUSTOMER_ID BIGINT, WAREHOUSE_ID BIGINT, PRIMARY KEY (id)) ENGINE = innodb;
