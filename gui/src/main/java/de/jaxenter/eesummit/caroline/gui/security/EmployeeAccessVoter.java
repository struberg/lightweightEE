...
/**
 * access decision voter for admin pages.
 */
@ApplicationScoped
public class EmployeeAccessVoter implements AccessDecisionVoter
{
    ...
    public Set<SecurityViolation> checkPermission(AccessDecisionVoterContext accessDecisionVoterContext)
    {
        ...
        if (!user.isLoggedIn() && !user.isEmployee())
        {
            ...
            violations.add(new DefaultSecurityViolation(messages.loginRequiredEmployee()));
            return violations;
        }
